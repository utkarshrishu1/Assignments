fetch('https://api.weatherapi.com/v1/current.json?key=5fd918100d0944458ff82048210708&q=London').then(res=>res.json()).then((res)=>{
...
document.getElementById('button').addEventListener('click',(event)=>{
    ...
    fetch('https://api.weatherapi.com/v1/current.json?key=5fd918100d0944458ff82048210708&q='+loc).then(res=>res.json()).then((res)=>{
        if(res.error)
        {
